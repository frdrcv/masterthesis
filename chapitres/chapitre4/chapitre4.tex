...
Comme nous pouvons l'observer par la richesse des résultat, plusieurs symboles désignent les communautés \lgbt{}.
Nous reviendrons dans cette section sur les principaux symboles de ces communautés pour s'intéresser au contexte historique dans lesquels ils ont surgit.
Le but ici est principalement de rendre compte de l'age assez ancien de ces dernier et de comprendre qu'à la base, ceux-ci se sont imposés avant d'être récupérés par la suite dans un mouvement politique défini.

Nous débuterons avec d'abord avec un symbole moins désignatif que d'autres mais dont l'historique est plus ancien et également controversé.
Il s'agit du triangle, utilisé encore quelques fois aujourd'hui par divers mouvement, autant radicaux que plus traditionnels.
Ce symbole nous provient de l'Allemagne nazie peu avant les premières purges basées sur l'ethnicité, et qui également cibleront les individus par leur appartenance politique, leur état de santé, et dans notre cas, leur orientation sexuelle.
En effet, le triangle était un symbole servant à catégoriser rapidement les individus désignés par ceux-ci.
Découpés dans du tissus, les triangles étaient cousus sur les vêtements portés par les individus arrêtés par les forces allemandes.
Tout un code de couleurs servaient à différencier les triangles entre eux, et un deux triangles jaunes superposés et inversés désignaient les personnes juives, rappellant ici l'étoile de David.
Pour les femmes lesbiennes, le triangle noir était le symbole les désignant, bien que ce code désignait également les personnes ayant des problèmes de santé mentale ou désignées comme asociale.
En ce qui concerne les hommes homosexuels, le rose était la couleur utilisée \missref{}.

Plusieurs décennies se sont déroulées avant que la symbole réapparaisse pour désigner les femmes et hommes homosexuels.
Une des manifestations les plus répandues de sa réapparition est la récupération qui en a été faite durant la crise du \vih{} au milieu des années 80.
C'est au plus fort de la crise, quand la communauté \lgbt{} a été la plus touchée que s'est formé les différentes organisations Act Up, d'abord aux États-Unis puis outre mer en France.
Cet organisation s'est attaquée très tôt aux élites politiques, considérées comme inactives et laissant l'épidémie faire des dommages au sein d'une population longtemps marginalisée, malgré les avancées politiques précédent de peu l'arrivée du \vih{}.
...
Le vécu d'individu racialisé est le principal motif à la non-mixité pour certains groupes \lgbt{}, bien que celle-ci soit supplémentaire à une non-mixité basée également sur le genre ou l'orientation sexuelle.
...
À première vue donc, ces événements n'ont pas d'autres buts que de permettre à des hommes ou à des femmes réputés homosexuels d'être en compagnie et de pouvoir trouver des relations sexuelles ou amoureuses.
...
Sachant que les rencontres entre individus du même genre pouvait être un risque à la sécurité des individus impliqués, il importait pour les communautés \lgbt{} de se prémunir de lieux non-mixtes pour assurer une sécurité minimale.
Bien qu'aujourd'hui une partie importante des jeunes \lgbt{} commence à fréquenter des lieux mixtes ou des soirées dans des bars n'était pas réputé comme \lgbt{}, les membres les plus anciens de la commuanuté peuvent toujours ressentir un besoin de retrouver des gens similaires pour socialiser.

Le contrôle de la non-mixité apparait différemment applicable selon les groupes.
Si on s'intéresse aux espaces et événements non-mixtes pour hommes, bien souvent, il s'agit d'événements situés dans des espaces fermés, et donc non-publics.
Ceux-ci ont donc un contrôle constant sur le genre des individus qui peuvent accéder ou non à l'espace, à la différence de certaines activités pour femmes, mais similaires aux groupes donc la non-mixité est basée également sur la racisation.
Bien que pour ces derniers, les événements organisés ne se déroulent pas dans des espaces très prompts à la socialisation, comme les bars, elles et ils choissisent selon notre collecte des locaux peu ou pas passants et l'accès semble basé sur la confiance.
C'est un peu sur cette base que s'organise la non-mixité des événements pour femmes lesbiennes qui se déroulent en public.
Bien que l'événement sois non-mixte, des passants sont présents, étant donné la nature des espaces utilisés --- rues, parcs, etc.
