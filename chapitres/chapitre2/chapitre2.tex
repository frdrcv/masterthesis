...
La ville de Québec en soit, fondée par des colonisateurs français, devient une possession britannique durant le \siecle{18} tout en demeurant un lieu essentiellement habité par des Canadiens français. 
...
À notre connaissance, pratiquement aucunes recherches ne se sont encore vraiment penchées sur la population \lgbt{} de la capitale. 
...
Le travail à partir de bases de données statistiques et géoréférencées permirent aux chercheurs de prendre un certain recul du sujet d'analyse et, du même coup, de prendre une distance avec la partie terrain de la collecte de données. 
...
À la suite de l'observation des espaces urbains ciblés et du travail en archives, l'ensemble des données ont subit un traitement de géolocalisation pour la plupart et de codage pour la totalité. 
...
Étant donné la couverture assez large de collecte de données sur dix années, certains établissements sont apparus et ont disparu, aujourd'hui remplacés par d'autres de même nature ou d'espaces totalement différents. 
...
En fait, si les groupes \lgbt{} sont en général considérés comme marginalisés, certains d'entre-eux le sont plus que d'autres, et donc, ont souvent un accès plus limités à des ressources permettant la mise en place de géosymbole à forte visibilité.
...
% \begin{quote}
%   \emph{Fugues} est offert sur différentes plateformes. La version imprimée est
...
%   Le site web \emph{Fugues}.com, quant à lui, suit l’actualité de plus près, et
...
Possédant moins de moyens que le magazine \emph{Fugues} étant donné la vocation communautaire du journal, il s'agit tout de même d'une des sources les plus complètes que nous avons traité dans cette recherche.
