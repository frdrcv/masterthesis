...
Il vise donc à montrer que la concordance entre le genre et le sexe d'un individu est  une des possibilités d'identification de genre comme l'identité  trans (ou  non binaire dans le genre, sans genre, etc., voir~\cite{Barker2015})~\citep[150]{McGeeney2015}.}. 
...
On sait par exemple que certains cinémas, comme le Midway dans les années 1920, auraient été un lieu de rencontres entre hommes\citep[30]{Higgins1999} \todo{a compléter}.
\begin{figure}[ht]
	\centering
...
Aujourd'hui, ses fonctions ont changé et on y retrouve principalement des locaux loués par les organismes communautaires appartenant à la communauté \lgbt{} de Québec.

À notre connaissance, pratiquement aucune recherche ne s’ est encore vraiment penchée à la population \lgbt{} de la capitale. 
...
La découverte et l'analyse des géosymboles d'un groupe culturel donné ne s'appuient pas sur une méthodologie particulière; au contraire, ils apparaissent suite à une observation approfondie du groupe étudié et de sa relation particulière avec le territoire. 
...
\begin{itemize}
    ...
    été prises, mais également sur les lieux où elles sont utilisées et/ou diffusées?
\end{itemize}
...
En effet, le journal Sorti s'étend sur sept années, soit de mai 2007 à décembre 2014. 
