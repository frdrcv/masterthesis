...
Ce chapitre se penchera plus particulièrement sur la méthodologie et nous définirons le cadre de l'étude, sois le lieu et la durée dans laquelle a eu lieu la collecte de données. 
...
Ce cadre historique s'intéressera principalement au cas de Montréal étant donné le peu d'écrits faits dans le domaine scientifiques sur les autres villes québécoises. 
...
\end{figure}
Aujourd'hui, Montréal est une métropole bien établie à l'échelle du continent nord-américaine. 
