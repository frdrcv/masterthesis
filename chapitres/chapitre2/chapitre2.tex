...
D'autres villes ont été envisagées pour ce travail de recherche, mais l'expérience terrain a été limitée aux deux espaces décrits précédemment. 
...
Si elles ne sont pas toujours présentes dans les travaux des chercheurs, nombreuses sont les études de cas à intégrer des photographies des espaces étudiés. 
On peut penser aux travaux en géographie physique où l'image peut servir à montrer au lecteur les différentes composantes d'un sous-sol par exemple ou encore, pour les travaux en géographie humaine, à montrer un paysage ou une organisation spatiale humaine particulière.
...
Au-delà d'un simple renouement avec une pratique traditionnelle, nous considérons qu'il s'agit d'une méthodologie qui a le potentiel de faire le pont avec la théorie en géographie culturelle et une des composantes importantes des groupes culturels minoritaires ou marginalisés, la visibilité. 
