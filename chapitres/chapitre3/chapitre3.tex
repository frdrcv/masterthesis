...
Dans le journal \emph{Sortie}, nous avons relevé vingt et une images, dont dix-neuf à propos de la ville de Québec.
...
Ce commerce n'a pourtant pas établi de succursales à Québec, celui-ci se situant à Montréal\footnote.{Nous nous pencherons sur ce symbole dans la section portant sur la ville de Montréal, quoique l'analyse que nous en tirerons s'appliquera également à la ville de Québec dans une moindre mesure.}.
...
\code{Le Drague} dans ses publicités offre des soirées récurrentes dans le temps en visant des types d'événements basés sur le contenu au lieu d'une clientèle précise; on retrouve donc à différentes reprises les symboles \code{homme} ou \code{femme}.
...
Des espaces comme \code{Le Drague} ont originellement été réservés à ceux-ci pour devenir mixtes par la suite.
...
Tel que visible aux figures~\ref{figs:saunas}, nous notons que ces espaces, différents entre eux, utilisent certains symboles pour marquer cette exclusivité.
En ce qui concerne le \code{Club \emph{Forhom}} par exemple, on peut comprendre par le nom qu'il s'agit d'une contraction des mots \code{for} et \code{hommes}, qu'on peut traduire par \emph{pour hommes}.
...
Ici, le terme back semble faire référence à aux termes de \code{back} ou de \code{bareback}.
\code{Back} pourrait faire allusion à l'entrée par en arrière, une des caractéristiques architecturales du lieu, tout comme en faisant allusion au sexe anal, dans lequel l'accent est mis sur la partie postérieure d'un des deux participants.
Cette explication est également applicable au possible \code{bareback}, qui fait référence ici au sexe anal encore une fois, mais sans condoms, une pratique sexuelle qui a longtemps été répandue dans les communautés homosexuelles masculines, mais de plus en plus marginalisée depuis la crise du \sida{}.
...
\begin{figure}[h!]
  ...
  \caption[Fête Arc-en-ciel de Québec]{Fête Arc-en-ciel de Québec: marche de solidarité et journée communautaire\todo{corriger les étiquettes de noms sans accents}}\label{fig:cartefetearcenciel}
\end{figure}
...
Une conférence par exemple a eu lieu sur les enjeux vécus par les personnes \code{trans} la veille du début de la Fête Arc-en-ciel et à l'extérieur de celle-ci, dans un bar de la basse-ville.
...
Souvent thématiques, ces soirées permettent aux hommes de se rencontrer dans un espace \emph{de facto} \code{non mixte}, sans être affiché comme tel, comparativement aux activités organisées par les communautés montréalaises \emph{dykes} ou racisées.
...
Le premier spectacle était l'œuvre d'un collectif queer rimouskois dans lequel le jeu autour du \code{genre} était clairement affiché par l'usage du \code{drag}.
...
Le symbole le plus utilisé est le \code{drapeau} \code{arc-en-ciel}; on peut voir celui-ci décorer autant pour des bars, des restaurants ou même des dépanneurs.
...
Les lieux exhibant à l'occasion des symboles sont principalement les \code{institutions bancaires} qui semblent être les entités les plus promptes par leurs moyens à montrer leur support par rapport à la communauté \lgbt.
...
À ce titre, on peut nommer les espaces \todo{phrase incomplète}

Comme pour les lieux queers que nous recenserons plus loin, les médias choisis dans la collecte de données semblent avoir un certain biais par rapport au type d'événements diffusés ou de lieux présentés.
...
\paragraph{Des lieux mettant de l'avant le fétichisme}
...
Parmi les bars mettant en avant un tel imaginaire, on peut nommer en ordre d'importance l'Aigle Noir, le \anglais{Tool} et \code{Le Drague}, à Québec, quoique, dans ce dernier cas, ces visuels ne sont plus utilisés aujourd'hui.
...
Comme nous l'avons souligné au début de cette section, les boutiques érotiques du quartier mettent de l'avant des géosymboles que nous rattacherons à la sexualité et au fétichisme, comme le drapeau cuir.
...
Tel qu'on peut le voir à la figure~\ref{fig:cartemarchetrans}, la manifestation commence à proximité du café Cléopâtre, traité précédemment, dans le cœur de l'ancien \anglais{Red Light} montréalais tel que désigné par~\citet{Chamberland1993a}.
...
Certains participants ont par contre décidé de leur propre initiative d'inscrire des slogans en lien avec le militantisme trans, de façon analogue à la Marche Dyke.
...
Nous avons noté la forte visibilité du \code{Parti Libéral du Canada} qui a utilisé un autobus et un grand nombre d'affiches représentant le \code{logo} du parti aux couleurs de l'\code{arc-en-ciel}.
\code{Québec Solidaire} avait aussi une présence importante, mais comme les autres partis, n'adaptait pas son visuel aux couleurs mises de l'avant dans la marche.
...
Tout comme la journée communautaire, les banques étaient présentes et avaient souvent leurs propres contingents aux couleurs de leur logos et de l'\code{arc-en-ciel}.
Mettant de l'avant les mêmes symboles, soit un mélange de \code{logos d'entreprise} et d'arc-en-ciel, celles-ci ont réussi à avoir une visibilité particulièrement importante dans le défilé.
D'autres entreprises ont également eu accès à une telle visibilité.
Nous pensons notamment à des entreprises comme \anglais{Homesense} ou à \emph{Viagra} et à \emph{Trojan} nommés précédemment.
...
Plusieurs des espaces affichés dans le magazine \emph{Fugues} recensé sont des campings.
...
Mettant souvent en scène des paysages naturels (que nous avons codé \code{nature}), on peut y voir aussi des tentes et des corps plus ou moins dénudés, musclés ou présentant une certaine partie du corps, comme le torse de façon similaire aux saunas pour hommes.
