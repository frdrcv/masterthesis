...
Le Drague dans ses publicités offre des soirées récurrentes dans le temps en visant des types d'événements basés sur le contenu au lieu d'une clientèle précise; on retrouve donc à différentes reprises les symboles \code{homme} ou \code{femme}.
...
Il s'agit du bar Saint-Matthew's, le Sauna Backboy's, le Sauna et le bar~\todo{Trouver les noms manquants}.
...
Il est donc nécessaire de se fier sur les autres fonctions du bâtiment, comme le club forhom, la présence par le passé de l'association \todo{trouver le nom du truc!} ou encore la gallerie homahom qui est également présente dans le bâtiment.
...
Il s'agit d'un ensemble de câbles hornés de boules roses de taille variés attachés au-dessus de la rue Sainte-Catherine, entre les rues Saint-Hubert et Frontenac \todo{vérifier les rues}.
