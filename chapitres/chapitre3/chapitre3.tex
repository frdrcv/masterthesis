...
Par exemple, le code \code{maquillage} a été classé dans la catégorie \code{visuel}, car celui qu'on retrouvait dans certaines images servait en fait de visuel au sein d'une publicité. 
...
Nous avons noté la présence d'individus vêtue de latex, de cuir et également de deux pratiquants du \anglais{puppy play}, par les symboles marquant leurs vêtements, mais aussi l'usage de masque à l'effigie de chien.
