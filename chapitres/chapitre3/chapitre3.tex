...
Sur le plan des services, les symboles sont plutôt orientés vers les soirées organisées dans les bars de la capitale, le cabaret-bar \code{Le Drague} et le Bar St-Matthew’s, ou encore dans les saunas comme L'Hippocampe.
...
\begin{figure}[ht]
  ...
  {\includegraphics[width=0.59\textwidth]{partydefilles1.jpg}}
...
Des espaces comme \code{\code{Le Drague}} ont originellement été réservés à ceux-ci pour devenir mixtes par la suite.
...
En ce qui concerne le \code{Club Forhom}, il s'agit plutôt d'un club privé dont l'on doit être membre pour pouvoir consommer des produits sur place.
...
En ce qui concerne le \code{Club Forhom} par exemple, on peut comprendre par le nom qu'il s'agit d'une contraction des mots \emph{for} et \emph{hommes}, qu'on peut traduire par \emph{pour hommes}.
...
L'autre sauna dans la ville de Québec est situé dans le même bâtiment que le \code{Club Forhom}.
...
Il est donc nécessaire de se fier sur les autres fonctions du bâtiment, comme le \code{Club Forhom}, la présence par le passé de l'association \todo{trouver le nom du truc!} ou encore la gallerie homahom qui est également présente dans le bâtiment.
...
En ce qui concerne les événements pour hommes gais, on peut nommer les soirées \emph{Boys Gone Wild}\todo{Vérifier si c'est le bon nom} et \todo{trouver l'autre événement} se déroulant tous les deux au Bar \emph{Saint-Matthew's}, un bar pour hommes comme nous l'avons souligné en début de section.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{marchedelafierte.png}\caption[Marche de la fierté]{Front avant de la marche de la fierté défilant sur la rue Saint-Jean. On peut y voir les différents commanditaires sur la banderolle ainsi que les drapeaux cuirs, \emph{puppy} et latex tenus par certains marcheurs.\label{fig:marchedelafierte}}
  \source{Frédéric Vachon}
\end{figure}
...
\begin{figure}[ht]
  ...
  {\includegraphics[width=0.37\textwidth]{aiglenoir}}
  \subcaptionbox{Image utilisée sur Facebook pour l'événement \anglais{Beardrop}\label{fig:beardrop}}
  {\includegraphics[width=0.62\textwidth]{beardrop}}
  \caption[Publicités utilisant une imagerie \bdsm{}]{Exemples de publicités dans le \emph{Fugue} pour des événements et des lieux utilisant une imagerie kink, fétichiste ou \bdsm{}.}\label{figs:fetichisme}
\source{\emph{Beardrop}, \emph{Fugue} et \agq{}}
\end{figure}
...
\begin{figure}[p]
  \centering
  \includegraphics[width=1\textwidth]{carteperverscite}
...
La publicité que nous avons relevée, visible à la figure \todo{Mettre la figure}, met de l'avant deux corps d'apparence masculine, très musclés, dans la pénombre avec une lumière rouge forte en arrière-plan.
...
Parmi les bars mettant en avant un tel imaginaire, on peut nommer en ordre d'importance l'Aigle Noir, le Tool et \code{Le Drague}, à Québec \todo{Vérifier l'ordre réel des bars utilisant ce type d'imagerie}.
...
Tel qu'on peut le voir à la figure \todo{insérer la   figure}, la manifestation commence à proximité du café Cléopâtre, traité précédemment, dans le cœur de l'ancien \anglais{Red Light} montréalais tel que désigné par~\citet{Chamberland1993a}.
...
Si certains de ceux-ci étaient publics, plusieurs d'entre eux visaient les individus arabes ou autochtones, en utilisant l'appellation \emph{bispirituelle} dans le dernier cas.
...
Certains utilisaient sur Facebook des extraits d'oeuvres si l'activité était un visionnement ou une exposition (figure~\ref{qouleurcinema}).
Enfin, une des activités publiques utilisaient une photo d'un évenement postérieur, dans ce cas-ci un picnic en extérieur (figure~\ref{qouleurpicnic}).
...
\begin{figure}[ht]
  ...
  {\includegraphics[width=0.59\textwidth]{sicksadsummer.jpg}}
  \subcaptionbox{Événement de 2008 (et événement mixte)\label{fig:partydefilles2}}
  {\includegraphics[width=0.4\textwidth]{partydefilles2.jpg}}
...
Nous pensons notemment à des entreprises comme \anglais{Homesense} ou à Viagra et à Trojan nommés précédemment.
...
\begin{figure}[p]
  \centering
  \includegraphics[width=1\textwidth]{cartefetearcenciel}
...
\begin{figure}[ht]
  ...
  {\includegraphics[width=0.59\textwidth]{saguenay}}
  ...
  \caption[événements en région]{exemples de publicités dans le \emph{fugues} d'activité en région. dans la première figure, on remarque l'usage de l'arc-en-ciel seul pour illustrer le caractère \lgbt{} du commerce alors que dans la seconde, on axe le visuel sur les attraits de la nature.}\label{figs:partydefilles}
...
Certains de ceux-ci sont d'ailleurs des espaces nudistes, comme le \todo{trouver un exemple}.
...
Grâce à Fugues, il a été possible d'identifier plusieurs lieux communautaires en région, sans nécessairement relever de géosymboles visuels.
