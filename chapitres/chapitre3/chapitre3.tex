...
Le classement des codes en catégorie s'est fait relativement aux images et textes qui sont liés avec les codes. 
...
Plutôt qu'être un maquillage porté par un individu et qui dans ce cas, aurait été instinctivement placé dans une catégorie comme \code{habillement} ou \code{public ciblé} si celui-ci avait été offert à des enfants.
...
Le Drague fait figure d'exception, car il s'agit du seul lieu hors Montréal de ce type, quoique cette impression ne soit pas la norme pour cet espace. 
...
On utilise donc qu'une partie des codes visuels permettant d'identifier les hommes rentrant dans la catégorie de \emph{bear}; on ne retrouve pas la carrure habituellement mise de l'avant, soit un surpoids important ou une carrure impressionnante.
...
La visibilité semble être le but premier derrière la \dm{}: ceci est particulièrement apparent par le choix esthétique de la bannière ornant l'événement Facebook, où l'on peut y voir des pictogrammes d'œil ainsi que dans le slogan utilisé. 
...
Elle débute avec une soirée organisée au cabaret Cléo où des spectacles variés ont lieu, ces derniers consistant surtout en des performances de dragues mettant en scène des artistes trans de la communauté.
...
On peut faire le lien entre cette affiche et certaines qui ont été utilisées par des événements non queers dans lesquels la chaleur de l'été figure, avec tout une série de signifiants positifs faisant l'expression du bonheur et du plaisir.
...
Cette absence de contenu politique ou festif peut témoigner d'une ouverture perçue plus grande de la société au sujet des enjeux \lgbt, ici la famille, au sein des participants de la marche.
Un contexte sans revendications dans lequel les participants pratiquent une activité pouvant être qualifiée de normale --- ou concordant avec la norme de la famille hétérosexuelle --- montre plutôt que ces familles peuvent être similaires aux autres et utiliser l'espace public comme n'importe quel ménage.
...
En soi, l'ensemble était comparable à une manifestation politique plutôt qu'à un défilé de la fierté plus traditionnel. 
En effet, dans ceux-ci, les groupes sont séparés par thématiques, ils utilisent des véhicules divers pour occuper l'espace de façon plus évocatrice et structurée et le public est à l'extérieur dans une position d'observation.
