...
\begin{figure}[h!]
  ...
  \caption[Fête Arc-en-ciel de Québec]{Fête Arc-en-ciel de Québec: marche de solidarité et journée communautaire\todo{corriger les étiquettes de noms sans accents}}
...
La partie ouest de la rue Saint-Jean-Baptiste et le carré d'Youville ont été décorés de nombreux \code{fanions,} \code{affiches} et \code{ornements} aux couleurs de l'\code{arc-en-ciel.}
...
En ce qui concerne les événements pour hommes \code{gais,} on peut nommer les événements \emph{Boys Gone Wild}, les \enquote{Soirées des barbus}, et les \enquote{soirées 100\% testostérone} se déroulant tous les deux au Bar \emph{Saint-Matthew's}, un bar pour hommes comme nous l'avons souligné en début de section.
...
Le premier spectacle était l'œuvre d'un collectif \qu rimouskois dans lequel le jeu autour du \code{genre} était clairement affiché par l'usage du \code{drag}.
...
Parmi ces chaines, on compte les Restaurants Saint-Hubert, \anglais{Subway}, \anglais{McDonald}, les cafés \emph{Starbucks}, \emph{Second Cup} ou encore les magasins \emph{Dollarama} et l'épicerie IGA.
...
\begin{figure}[ht]
  ...
  \subcaptionbox{Image utilisée sur Facebook pour de cinéma à vélo au \anglais{Beaver Lake} sur le Mont-Royal\label{fig:femmesupremacy}}
