...
En 2016, avec la fermeture de la totalité de ces lieux, la communauté lesbienne n'est visible que durant certains événements organisées dans des lieux variés.
...
Comme pour les lieux queers que nous recenseront plus loin, les médias choisis dans la collecte de données semblent avoir un certain biais par rapport au type d'événement diffusé ou de lieux présentés.
...
En effet, nous n'avons pas trouvé d'indications laissant croire que de tels lieux existent, ni même de référence à ces groupes, malgré que notre connaissance personelle de ce milieu et l'existence d'un festival comme Pervers\Cité.


\paragraph{Une multitude de lieux mixtes}
Comme nous l'avons souligné précédemment, le village gai apparait aujourd'hui comme un espace relativement mixte en considérant que plusieurs de ses commerces étaient plutôt orientés spécifiquement envers la communauté homosexuelle masculine.
...
En général, ces espaces utilisent plutôt des symboles propres au genre de lieux qu'ils désirent mettre de l'avant, quel type de clientèle ils recherchent sans égard envers l'orientation sexuelle.
...
Ceux-ci, sans souligner une certaine exclusivité, sont, comme plusieurs des bars que nous avons rencensés précédemment, sont orientés vers les hommes.
