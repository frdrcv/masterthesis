...
Cette position nous apparait baisée, alors que l'on devrait plutôt comprendre que groupes aux limites artificielles et objet à des interactions avec d'autres populations sont destinées à évoluer, avec ou sans la présence des schémas de colonisation comme le souligne~\citet[79--80]{DiMeo2007}.
...
Les différences spatiales contribueraient donc aux développements de différences socioculturelles et rend chaque groupe identitaire différent, quoique, avec l'avénement des communications de masse, le phénomène soit maintenant incertain.
...
En général, ces travaux se sont limités aux identités et communautés gaies et lesbiennes; nous avons donc tenter, dans ce mémoire, d'aborder les géosymboles liés aux autres groupes.
