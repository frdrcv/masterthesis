...
Le premier courant serait représenté par les chercheurs pratiquant la sémiologie traditionnelle ou courante (\anglais{mainstream} dans le texte), principalement intéressés à déconstruire les médias pour y chercher les signes, unités de base de la sémiotique.
