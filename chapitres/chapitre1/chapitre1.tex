...
\chapterprecishere{\textquote{J’ai abandonné depuis longtemps l’idée qu’une vérité immanente se trouve dans la sexualité, qu’elle soit marquée par le
...
Les symboles plus particulièrement sont pour Geertz dans son modèle\todo{à étoffer}, en reprenant les termes de~\cite{Langer1962}: \textquote{\textelp{} tout objet, acte,
  événement, propriété ou relation qui sert de véhicule à un concept --- le concept est la \textquote{signification du symbole }~\citep[23--24]{Geertz1972}}. 
