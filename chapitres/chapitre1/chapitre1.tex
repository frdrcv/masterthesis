...
Au lieu que d'être les héritiers directs d'une culture \qu{}, on doit plutôt concevoir que les individus \qus{} possèdent bel et bien la culture dominante, mais que leur intégration sociale passe par d'autres trajets que ceux proposés normalement par celle-ci.
...
La longévité peut est signifiée par des signifiants différents comme une personne très âgée, alors que le signifiant d'arbre rappelle très rapidement le signifié d'arbre sans mise en contexte. 
...
On peut penser aussi au champ de la géographie physique ou de la biogéographie qui traitent bien souvent les substrats rocheux ou le monde du vivant dans des ensembles comme les \todo{trouver le mot manquant} comme des données quantifiables. 
