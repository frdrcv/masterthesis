...
Les individus \lgbt{}, à leur naissance, s'insèrent de facto dans un contexte culturel dont les symboles n'ont que peu à voir avec les identités sexuelles non hétérosexuelles. 
...
Hall propose une généalogie simplifiée du concept d'identité et ses évolutions selon les différentes étapes socio-économiques des derniers siècles et donc des courants de pensée y étant liés\todo{trop vague}. 
...
Sans entrer en profondeur dans les détails de sa production, Hall souligne qu'il s'agit du sujet né des idées des lumières. 
...
En effet, selon Hall, celui-ci apparait lorsque la psychologie et la psychanalyse prennent de l'importance. 
Ces dernières concentrent leur analyse sur l'individu dans son plus for intérieur et ses relations particulières avec son environnement immédiat lors de la constitution de sa personnalité, à savoir les membres de sa famille et surtout ses parents. 
...
Ce sujet sociologique est donc en relation avec les autres individus ainsi qu'avec \textquote[{\citeyear[597]{Hall1996a}}][]{les valeurs, les
...
En somme, les systèmes symboliques prennent une importance qui dépasse les individus malgré qu'on commence à voir apparaitre une complexification des identités possibles suite au bouleversement des institutions réputées immuables par le renversement bourgeois des traditions et des systèmes de royauté. \todo{Dater!}
...
Cette décomposition remet radicalement selon l'auteur la position de Rousseau sur la Raison individuelle: l'individu n'est maintenant plus maître de sa vie, mais possède en lui des pulsions aussi variées qu'incomprises et une partie de lui-même, héritée socialement, le dépasse et a une influence très importante sur sa propre vie. 
Les autres autour de lui, la famille d'abord, ont des rôles particuliers dans sa vie qui l'amène maintenant à ne plus se construire lui-même de façon autonome, mais plutôt en relation avec les autres, selon des versions symboliques que ceux-ci représentent pour l'adulte à venir~\citeyearpar[ 607--608]{Hall1996a}.

La troisième cassure est celle opérée par les travaux de Ferdinand de Saussure sur le langage. 
...
Par des dispositifs de surveillance toujours plus élaborés, non seulement les criminels seront surveillés, mais également le reste de la société. 
On peut penser aux écoles et aux hôpitaux par exemple qui acquirent les technologies développées dans les centres pénitenciers, sous le couvert d'assurer une discipline dans les lieux.
...
Ce mouvement permis la mise en place des identités politiques pour chacun de ces nouveaux mouvements de contestation et permettre de nouvelles formes de contestation sociales et politiques~\citeyearpar[610]{Hall1996a}.


Comme on peut le voir, le sujet sociologique et le sujet post-moderne sont particulièrement similaires sur plusieurs points: plusieurs des facteurs ayant mis en place le sujet sociologique en sont venu à le déstabiliser avec les décennies, quoique Hall ne fait pas une généalogie claire et datée de ces déstabilisations; il faut plutôt s'appuyer sur les généalogies internes à chacun des travaux ou événements et leur moment d'apparition dans l'histoire moderne.
On doit plutôt concevoir ceux-ci d'une part comme des facteurs de déstabilisations et des œuvres les expliquant, qui ont amené la mise en place du sujet post-moderne. 
...
Au-delà de la complexification des rapports sociaux, cette individualisation a ouvert de nouvelles voies pour l'individu pour arriver à coordonner sa place en société. 
Pour \citeauthor{Hall1996a}, ce sujet:
...
about ourselves}.
\foreigntextquote{english}[{\citeyear[610]{Hall1996a}}][.]{Since identity shifts
according to how the subject is addressed or represented, identification is
not automatic, but can be won or lost. It has become politicized. This is
sometimes described as a shift from a politics of (class) identity to a
politics \emph{difference}} 
Ces changements importants chez l'individu ouvrent la porte à d'autres formes d'identités jusque là improbable à imaginer. 
Nous pouvons conclure cette partie en soulignant que ces bouleversements et les événements historique du dernier siècle ont ainsi permis l'éclosion de l'identité homosexuelle, notamment par le traitement qu'à subie l'orientation sexuelle par le système de santé et par la psychanalyse et une distance du pouvoir qui permis l'apparition de groupes d'affinités autour de la question sexuelle. 
Ainsi, on arrive d'une certaine façon à dépasser certaines des limites inhérentes à la vision \emph{geertzienne} de la culture dans laquelle l'attachement à une identité comme la religion pour un occidental passait principalement par la pratique. 
...
\label{sec:diversit_sexuelle_et_identit_} Comme nous l'avons vu dans la section précédente, l'identité homosexuelle peut être considérée comme une création récente propre au contexte post-moderne des dernières décennies. 
Ce constat s'explique notamment par le contexte historique récent dans lequel s'inscrit cette identité ainsi que par la correspondance à certaines caractéristiques proposées par Hall, à savoir qu'il s'agit d'une identité à laquelle les individus s'inscrivent en parallèles à d'autres formes identitaires, comme la communauté ethnique, nationale ou encore de genre, par exemple.
\citet{Sinfield1996}, dans \citetitle{Sinfield1996}, traite des difficultés et contradictions propres à l'usage de l'identité chez les communautés \lgbt{} par rapport aux phénomènes historiques récents de libération sexuelle en occident et du développement d'un regard critique sur l'essentialisation des communautés sexuelles au sein de certains des premiers travaux liés à la théorie queer qui tentèrent de dépasser la \emph{pathologisation} de la sexualité comme on la retrouvait dans les travaux en psychanalyse. 
...
Cette compartimentation de la subjectivité individuelle amène les individus touchés à promouvoir une caractéristique d'eux-mêmes et donc de vivre une rapprochement avec les autres individus touchés et qui se reconnaissent dans cette identité potentielle. 
...
C'est ce mode stratégique qui se serait par la suite répandu dans les autres mouvements de contestations et qui aurait stratégiquement promu le modèle de l'ethnicité-et-des-droits.
...
\enquote{Black} is the organizing principle: instead of colluding with hegemonic
...
of the (heterosexual) culture of our childhood, where we are no longer \enquote{at
...
founded in the shared condition of being not-heterosexual --- compare \enquote{people
of colour}, whose collocation derives from being not-white}. 
Étant donné cet accent mis sur la non-correspondance à une norme, la communauté gaie et lesbienne, et on pourrait rajouter bisexuelle et trans, est nécessairement très large et diverse. 
...
insisting on \enquote{subculture}, as opposed to \enquote{identity} or \enquote{community}: I envisage
...
Ce texte s'inscrit donc ainsi moins dans l'étude d'un groupe culturel particulier que sur les conflits enrourant les normes sociales d'un ensemble culturel. 
...
Après avoir perdu en valeur, ces centres sont de nouveau habités par les classes aisées et reconditionnés selon les moyens des investisseurs s'accaparant ces espaces par le phénomènes décrits par de nombreux chercheurs sous le terme de gentrification or d'embourgeoisement.
...
À notre connaissance, aucun travail ne traite spécifiquement de la sémiotique en géographie \qu\ et il s'agit d'une lacune en considérant le potentiel de cette approche dans l'étude de l'espace et au sein de la géographie culturelle.
...
D'emblée, nous pouvons déjà considérer que des événements comme les \anglais{gay pride} (ou Fierté gaie), les manifestations politiques pour les droits gays et lesbiens, les centres communautaires offrant des services aux individus porteur du \vih, les bars lesbiens ou encore des lieux de dragues dans des espaces publics sont tous des exemples d'espaces \lgbt{} portant en eux des marques particulières, des logos ou des apparences qui entrent dans la définition du géosymbole.
