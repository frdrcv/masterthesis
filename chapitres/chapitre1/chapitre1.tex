...
Geertz précède alors son analyse des systèmes religieux\todo{À étoffer, que sont-ils?} par une définition renouvelée de ce qu'est la culture ou plutôt le système culturel. 
...
Ces deux phénomènes sont en fait les deux manières qu'ont les modèles de de donner sens aux symboles qu'ils contiennent; ils dirigent la compréhension des symboles en calquant ceux-ci sur le réel non-symbolique et en liant ensemble les éléments composant ce réel\todo{a revérifier}.
...
Au contraire, le point de vue d'universalisation coïncide avec le champ de pensée constructiviste; en effet, on voit la sexualité comme une donnée variable chez les individus dont la position sociale, l'éducation et l'environnement auront un effet prépondérant et dont le sens prendra une valeur différente selon la culture traitée. 
...
Ces derniers peuvent également avoir un effet sur ces normes, l'auteur prenant exemple sur les familles homoparentales dans les banlieues. 
...
On le constate rapidement, ce modèle n'a \latin{a priori} rien de très géographique en soi. 
...
Nous ferons ensuite la synthèse à l'aide du concept de géosymbole tel qu'articulé par \citet{Bonnemaison1981}.
...
Contrairement aux anciennes perspectives en géographie culturelle qui définissait la culture comme une entité à part, homogène et où régnait une apparence de consensus~\citep{Duncan1980}, la réalité semble s'éloigner de cette image. 
...
On peut croire également que celle-ci offrirait la possibilité de montrer la diversité des lieux, leur positionen permettantr une compréhension plus poussée de l'utilisation de l'espacepar less communautés \lgbt{}. 
